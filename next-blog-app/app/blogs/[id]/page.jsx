...
const page = ({ params }) => {
  ...
  const fetchBlogData = () => {
    for (let i = 0; i < blog_data.length; i++) {
      //execute this for loop untill params data is matching to blog id
      //and set the blogdata into setter function
      if (Number(params.id) === blog_data[i].id) {
        setData(blog_data[i]);
        console.log("blogdata", blog_data[i]);
        break;
      }
    }
  };
    ...
    <>
      ...
      <div className="mx-5 max-w-[800px] md:mx-auto mt-[-100px] mb-10">
        ...
        <p className="my-3">
          ...
          understanding of what you want to achieve.Start by relecting on your
          values, aspirations, and long-trm goals.
        </p>
        <p className="my-3">
          Before you can manage your lifestyle, you must have a clear
          understanding of what you want to achieve.Start by relecting on your
        ...
        <p className="my-3">
          Managing your lifestyle is a journe that requires commitment and
          self-awareness. By following this step-by-setp guide, you can take
